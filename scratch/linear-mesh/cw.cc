...
bool MyExecuteActions(Ptr<OpenGymDataContainer> action)
{
    ...
    if(!dry_run){
        Config::Set("/$ns3::NodeListPriv/NodeList/*/$ns3::Node/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::WifiMac/BE_Txop/$ns3::QosTxop/MinCw", UintegerValue(CW));
        Config::Set("/$ns3::NodeListPriv/NodeList/*/$ns3::Node/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::WifiMac/BE_Txop/$ns3::QosTxop/MaxCw", UintegerValue(CW));
    }
    return true;
}
...
void set_phy(int nWifi, int guardInterval, NodeContainer &wifiStaNode, NodeContainer &wifiApNode, YansWifiPhyHelper &phy)
{
    ...
    // Guard interval is set on HeConfiguration after device installation (see set_nodes)
}
...
{
    // Set channel width via ChannelSettings (ns-3.40 API)
    ...
    // Set guard interval on HeConfiguration for 802.11ax
    ...
    else
    {
        ...
        Config::Set("/$ns3::NodeListPriv/NodeList/*/$ns3::Node/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::WifiMac/BE_Txop/$ns3::QosTxop/MinCw", UintegerValue(16));
        Config::Set("/$ns3::NodeListPriv/NodeList/*/$ns3::Node/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::WifiMac/BE_Txop/$ns3::QosTxop/MaxCw", UintegerValue(1024));
    }
}
